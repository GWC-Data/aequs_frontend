...
// //     sampleQty: string;
// //     rows: FormRow[];
// //     customColumns?: CustomColumn[]; // Store custom column definitions
// // }
...
// //         // Update form data with new column
// //         const updatedFormData = {
// //             ...formData,
// //             customColumns: [...(formData.customColumns || []), customColumn]
// //         };

// //         // Add the new column to all existing rows
// //         updatedFormData.rows = updatedFormData.rows.map(row => ({
// //             ...row,
// //             [columnId]: ''
// //         }));

// //         // Update the form (you'll need to pass this up to parent)
// //         Object.keys(updatedFormData).forEach(key => {
// //             if (key !== 'rows' && key !== 'customColumns') {
// //                 updateFormField(key, (updatedFormData as any)[key]);
// //             }
// //         });
...
// //                 if (field !== 'id' && field !== 'srNo') {
// //                     updateRowField(row.id, field, row[field]);
// //                 }
// //             });
// //         });
...
// //                     <h2 className="text-3xl font-bold text-gray-900">DefaultForm Test</h2>
...
// //                             <button
// //                                 type="submit"
// //                                 className="flex items-center w-fit border rounded-sm bg-[#f35b62] text-white p-2 hover:bg-[#EE161F] hover:text-white transition-colors"
// //                             >
...
// //                                         <th key={column.id} className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">
// //                                             {column.label}
// //                                         </th>
// //                                     ))}
...
// //                                         {formData.customColumns?.map((column) => (
// //                                             <td key={column.id} className="px-4 py-4 border-r border-gray-200">
