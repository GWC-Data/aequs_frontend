...
//                   <Button className="w-full bg-blue-600 hover:bg-blue-700 rounded-lg" onClick={() => handleQuickAction("New Product Check-in")}>
//                     New Product Check-in
//                   </Button>
//                   <Button className="w-full bg-green-600 hover:bg-green-700 rounded-lg" onClick={() => handleQuickAction("Start New Test")}>
//                     Start New Test
//                   </Button>
//                   <Button className="w-full bg-gray-400 hover:bg-gray-500 rounded-lg" onClick={() => handleQuickAction("View Test Reports")}>
//                     View Test Reports
//                   </Button>
//                 </CardContent>
//               </Card>
...
//                 className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-l-blue-500 bg-white rounded-xl"
//               >
...
import { Input } from "@/components/ui/input";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Package, TestTube, TrendingUp, Search, Clock, CheckCircle2, Activity } from "lucide-react";
import { Progress } from "@/components/ui/progress";
import { 
  dashboardStats, 
  allProducts, 
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { icon: Package, color: "blue", title: "Total Products", value: dashboardStats.totalProducts, sub: "+10% vs last month" },
                { icon: TestTube, color: "purple", title: "Under Testing", value: dashboardStats.underTesting, action: "testing" },
                { icon: CheckCircle2, color: "green", title: "Completed", value: dashboardStats.completed, action: "complete" },
                { icon: Clock, color: "orange", title: "Scheduled", value: dashboardStats.scheduled, action: "scheduled" },
              ].map((item, i) => (
                <Card
                  key={i}
                  onClick={item.action ? () => setStatusFilter(item.action) : undefined}
