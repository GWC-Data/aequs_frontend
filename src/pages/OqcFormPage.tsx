...
const OQCSystem = () => {
  ...
  useEffect(() => {
    if (formData.project && formData.colour && formData.anoType && formData.reason && formData.totalQuantity > 0) {
  ...
  }, [formData.project, formData.colour, formData.anoType, formData.reason, formData.totalQuantity, testRecords]);
