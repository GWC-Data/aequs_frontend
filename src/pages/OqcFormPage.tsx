...
//   const [ortStage1Data, setOrtStage1Data] = useState<any[]>([]);

//   useEffect(() => {
//   // Load ORT Stage 1 data to check for not received sessions
//   const loadORTStage1Data = () => {
//     try {
//       const stage1DataStr = localStorage.getItem("stage1TableData");
//       if (stage1DataStr) {
//         const stage1Data = JSON.parse(stage1DataStr);
//         setOrtStage1Data(stage1Data);

//         // Also check for not received sessions
//         const notReceivedSessions = stage1Data.filter(
//           (item: any) => item.received === "No"
//         );
//         console.log("Not received sessions from ORT:", notReceivedSessions);
//       }
//     } catch (error) {
...
// // Function to get not received sessions from stage1TableData
// const getNotReceivedSessions = () => {
//   return ortStage1Data.filter((item: any) => 
//     item.received === "No" && 
...
// const handleReUploadFromORT = (ortSession: any) => {
...
// // Function to clear not received status (mark as resolved in ORT data)
// const handleClearNotReceived = (sessionId: string) => {
//   if (window.confirm('Mark this session as resolved? This will remove it from the not received list.')) {
//     // Update the ORT stage1 data to mark as resolved
//     const updatedOrtData = ortStage1Data.map((item: any) => {
...
//     }
//   } catch (error) {
//     console.error("Error refreshing ORT data:", error);
//   }
// };
...
const OQCSystem = () => {
  ...
  const getNotReceivedSessions = () => {
    return ortStage1Data.filter(item =>
      item.received === "No" &&
      item.status === "Not Received"
    );
  };
